...
namespace ArgusTV.DataContracts
{
    ...
    public partial class GuideProgram : IProgramSummary
	{
        ...
        {
            get => _title;
            set => _title = null == value ? null : Encoding.UTF8.GetString(Encoding.Default.GetBytes(value));
        }
        ...
        {
            get => _subtitle;
            set => _subtitle = null == value ? null : Encoding.UTF8.GetString(Encoding.Default.GetBytes(value));
        }
        ...
        {
            get => _description;
            set => _description = null == value ? null : Encoding.UTF8.GetString(Encoding.Default.GetBytes(value));
